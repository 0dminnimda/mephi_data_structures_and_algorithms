...
#define PLATFORM_WINDOWS_32  1 << 0
#define PLATFORM_WINDOWS_64  1 << 1
#define PLATFORM_CYGWIN      1 << 2
#define PLATFORM_WINDOWS     1 << 3 | PLATFORM_WINDOWS_32 | PLATFORM_WINDOWS_64 | PLATFORM_CYGWIN

#define PLATFORM_APPLE       1 << 10
#define PLATFORM_BSD         1 << 11 | PLATFORM_APPLE

#define PLATFORM_LINUX       1 << 20
#define PLATFORM_HPUX        1 << 21
#define PLATFORM_AIX         1 << 22
#define PLATFORM_SOLARIS     1 << 23
#define PLATFORM_UNIX        1 << 24 | PLATFORM_BSD | PLATFORM_LINUX | PLATFORM_HPUX | PLATFORM_AIX | PLATFORM_SOLARIS

#define PLATFORM_POSIX       1 << 30 | PLATFORM_CYGWIN | PLATFORM_BSD | PLATFORM_UNIX & ~(PLATFORM_LINUX)
